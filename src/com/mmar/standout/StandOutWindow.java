...
import com.mmar.R;
import com.mmar.standout.constants.StandOutFlags;
...
public abstract class StandOutWindow extends Service {
	...
	public static Intent getSendDataIntent(Context context,
		...
		return new Intent(context, toCls).putExtra("id", toId)
				...
				.putExtra("com.mmar.standout.data", data)
				.putExtra("com.mmar.standout.fromCls", fromCls)
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (intent != null) {
			...
			if (ACTION_SHOW.equals(action) || ACTION_RESTORE.equals(action)) {
				...
				Bundle data = intent.getBundleExtra("com.mmar.standout.data");
				int requestCode = intent.getIntExtra("requestCode", 0);
				@SuppressWarnings("unchecked")
				Class<? extends StandOutWindow> fromCls = (Class<? extends StandOutWindow>) intent
						.getSerializableExtra("com.mmar.standout.fromCls");
	...
	public int getFlags(int id) {
		return StandOutFlags.FLAG_DECORATION_SYSTEM|StandOutFlags.FLAG_BODY_MOVE_ENABLE|StandOutFlags.FLAG_WINDOW_BRING_TO_FRONT_ON_TOUCH|StandOutFlags.FLAG_WINDOW_PINCH_RESIZE_ENABLE|StandOutFlags.FLAG_WINDOW_HIDE_ENABLE|StandOutFlags.FLAG_DECORATION_CLOSE_DISABLE;
	}
	...
	public Intent getPersistentNotificationIntent(int id) {
		return getCloseIntent(this,getClass(),id);
	}
	...
	public Intent getHiddenNotificationIntent(int id) {
		return getShowIntent(this,getClass(),id);
	}
	...
	public Notification getPersistentNotification(int id) {
		...
		Notification n=new Notification.Builder(c).setContentTitle(contentTitle).setContentText(contentText).setContentIntent(contentIntent).build();
		n.icon=icon;
